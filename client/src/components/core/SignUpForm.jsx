  ...
  handleSubmit = (ev) => {
    ...
    if (this.props.isSignUpVerificationCodeSent) {
      this.props.onSignUpVerification({
        ...
        code: this.state.verificationFields.code,
      });
    } else {
      this.props.onSignUp({
        email: this.state.signUpFields.email,
  ...
  render() {
    return (
      <form onSubmit={ev => this.handleSubmit(ev)} method="post">
        ...
        <h2 style={{ padding: '40px' }}><b>Sign Up</b></h2>
          ...
          <div>
            <div className="form-content-element">
              <label className="form-field-label" htmlFor="email">Email
                <input value={this.state.signUpFields.email || ''} type="email" className="form-input-text-element" id="email" name="email" placeholder="user@email.example" onChange={this.onChange} />
              </label>
              <p className={`error-message ${!this.state.signUpErrors.email && 'hidden'}`}>{this.state.signUpErrors.email}</p>
            </div>
            <div className="form-content-element">
              <label className="form-field-label" htmlFor="password">Password
                <input value={this.state.signUpFields.password || ''} type="password" className="form-input-text-element" id="password" name="password" placeholder="Password" onChange={this.onChange} />
              </label>
              <p className={`error-message ${!this.state.signUpErrors.password && 'hidden'}`}>{this.state.signUpErrors.password}</p>
            </div>
            <div className="form-content-element">
              <label className="form-field-label" htmlFor="name">Name
                <input value={this.state.signUpFields.name || ''} type="text" className="form-input-text-element" id="name" name="name" placeholder="Name" onChange={this.onChange} />
              </label>
              <p className={`error-message ${!this.state.signUpErrors.name && 'hidden'}`}>{this.state.signUpErrors.name}</p>
            </div>
            <div className="form-content-element">
              <label className="form-field-label" htmlFor="phone">Phone
                <input value={this.state.signUpFields.phone || ''} type="text" className="form-input-text-element" id="phone" name="phone" placeholder="Phone Number" onChange={this.onChange} />
              </label>
              <p className={`error-message ${!this.state.signUpErrors.phone && 'hidden'}`}>{this.state.signUpErrors.phone}</p>
            </div>
          </div>}
          {this.props.isSignUpVerificationCodeSent &&
          <div className="form-content-element">
            <label className="form-field-label" htmlFor="code">Verification Code
              <input value={this.state.verificationFields.code || ''} type="text" className="form-input-text-element" id="code" name="code" placeholder="Verification Code" onChange={this.onChange} />
            </label>
            <p className={`error-message ${!this.state.verificationErrors.code && 'hidden'}`}>{this.state.verificationErrors.code}</p>
          </div>
          }
          <div className="form-content-element">
